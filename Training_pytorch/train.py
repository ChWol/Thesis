...
if args.optimizer == 'adam':
    optimizer = optim.Adam([{"params": model.classifier[0].parameters(), "lr": 1e-1}, {"params": model.classifier[1].parameters(), "lr": 1e-3}, {"params": model.classifier[2].parameters(), "lr": 1e-3}],

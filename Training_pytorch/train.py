...
parser.add_argument('--nonlinearityLTP', type=float, default=1, help='nonlinearity in LTP')
parser.add_argument('--nonlinearityLTD', type=float, default=-1, help='nonlinearity in LTD (negative if LTP and LTD '
                                                                        'are asymmetric)')

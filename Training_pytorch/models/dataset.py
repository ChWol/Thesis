...
def get10(batch_size, data_root='/tmp/public_dataset/pytorch', train=True, val=True, **kwargs):
    data_root = os.path.expanduser(os.path.join(data_root, 'cifar10-models'))
...
def get100(batch_size, data_root='/tmp/public_dataset/pytorch', train=True, val=True, **kwargs):
    data_root = os.path.expanduser(os.path.join(data_root, 'cifar100-models'))
    num_workers = kwargs.setdefault('num_workers', 1)
    kwargs.pop('input_size', None)
...
def get_fashion(batch_size, data_root='/tmp/public_dataset/pytorch', train=True, val=True, **kwargs):
    data_root = os.path.expanduser(os.path.join(data_root, 'fashion-models'))
    num_workers = kwargs.setdefault('num_workers', 1)
    kwargs.pop('input_size', None)
